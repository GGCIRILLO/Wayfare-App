    ...
    init() {
        let _locations = [
            Location(
                ...
                cost: "Free",
                activities: [
                    SpecificActivity(activity: LocationsData.getActivityByName(name: "Running"), stars: 3),
                    SpecificActivity(activity: LocationsData.getActivityByName(name: "Football"), stars: 3),
                    SpecificActivity(activity: LocationsData.getActivityByName(name: "Yoga"), stars: 5),
                ]
            ),
            Location(name: "Campo di Montedonzelli",
                     ...
                     cost: "Free",
                     activities: [
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Basketball"), stars: 4)
                     ]
                    ),
            ...
            Location( name: "Parco dei Quartieri Spagnoli",
                      ...
                      cost: "Free",
                      activities: [
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Open Gym"), stars: 5),
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Biking"), stars: 2),
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Football"), stars: 3)
                      ]
                    ),
            Location(name: "Parco Tortora Brayda",
                     ...
                     cost: "Free",
                     activities: [
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Running"), stars: 0),
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Open Gym"), stars: 3)
            ...
            Location(name: "Vesuvio",
                     ...
                     cost: "Free",
                     activities: [
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Hiking"), stars: 3),
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Walking"), stars: 5),
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Running"), stars: 4)
            ...
            Location(name: "Villa Floridiana",
                     ...
                     cost: "Free",
                     activities: [
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Running"), stars: 2),
                        SpecificActivity(activity: LocationsData.getActivityByName(name: "Walking"), stars: 4)
                     ]),
            Location(name: "Via Caracciolo",
                     ...
                     cost: "Free",
                     activities: [
                            SpecificActivity(activity: LocationsData.getActivityByName(name: "Biking"), stars: 5),
                            SpecificActivity(activity: LocationsData.getActivityByName(name: "Running"), stars: 5),
                            SpecificActivity(activity: LocationsData.getActivityByName(name: "Walking"), stars: 5)
                     ]
                    ),
            Location(name: "Campo sportivo San Rocco",
                     ...
                     distance: 7.5,
                     cost: "Paid",
                     activities: [SpecificActivity(activity: LocationsData.getActivityByName(name: "Football"), stars: 4)])
        ]
